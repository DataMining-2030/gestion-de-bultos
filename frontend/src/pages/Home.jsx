      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="mb-0 inline-flex items-center gap-3 text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {menuOptions.map((option) => (
              ...
              >
                ...
                <h3
                  className={`text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2 transition-colors ${option.disabled
                    ? ''
